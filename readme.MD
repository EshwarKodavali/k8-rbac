...
```
eksctl create iamserviceaccount --cluster roboshop-dev --name secret-reader --namespace roboshop --attach-policy-arn arn:aws:iam::859679100707:policy/RoboShopMySQLSecretReader --approve
```
